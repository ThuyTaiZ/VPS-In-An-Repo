...
read -p "Paste your Ngrok authtoken here (Copy the token and paste it here then press Enter): " CRP
./ngrok authtoken $CRP 
...
echo ================================
sudo qemu-system-x86_64 -vnc :0 -hda lite10.qcow2  -smp cores=2  -m 12288M -machine usb=on -device usb-tablet > /dev/null 2>&1
